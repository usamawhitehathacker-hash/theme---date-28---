...
class HeaderComponent extends Component {
  ...
  #updateScrollState = () => {
    ...
    if (!this.#offscreen && stickyMode !== 'always' && stickyMode !== 'shrink') return;
  ...
  connectedCallback() {
    ...
    const stickyMode = this.getAttribute('sticky');
    if (stickyMode) {
      this.#observeStickyPosition(stickyMode === 'always' || stickyMode === 'shrink');

      if (stickyMode === 'scroll-up' || stickyMode === 'always' || stickyMode === 'shrink') {
